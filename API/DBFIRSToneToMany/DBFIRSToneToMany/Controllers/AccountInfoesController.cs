...
using DBFIRSToneToMany.Models;

namespace DBFIRSToneToMany.Controllers
{
    ...
    public class AccountInfoesController : ControllerBase
    {
        ...
        public AccountInfoesController(BankContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<AccountInfo>>> GetAccountInfos()
        {
          if (_context.AccountInfos == null)
          {
            ...
            return await _context.AccountInfos.Include(x=>x.Transactions).ToListAsync();
        }
        ...
        public async Task<ActionResult<AccountInfo>> PostAccountInfo(AccountInfo accountInfo)
        {
          if (_context.AccountInfos == null)
          {
              return Problem("Entity set 'BankContext.AccountInfos'  is null.");
          }
